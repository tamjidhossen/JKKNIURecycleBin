...
import com.example.recyclebin.databinding.RowImagesPickedBinding;
...
public class AdapterImagesPicked extends RecyclerView.Adapter<AdapterImagesPicked.HolderImagesPicked> {
    ...
    /**Constructor* @param context The context of activity/fragment from where instance of AdapterImagesPicked class is created * @param imagePickedArrayList The list of the **/
